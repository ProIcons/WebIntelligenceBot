...
namespace WebIntelligence.Bot.Helpers.Permissions;
...
public static class DiscordPermissionHelperExtensions
{
    ...
    public static bool HasUserPermissionOverwrite(
        ...
        .Any(x => x.Type == PermissionOverwriteType.Member
                  ...
                  && (discordPermissionType == DiscordPermissionType.All && (x.Allow.HasPermission(discordPermission) ||
                                                                             x.Deny.HasPermission(discordPermission))
                      || discordPermissionType == DiscordPermissionType.Allow &&
                      x.Allow.HasPermission(discordPermission)
    ...
    public static bool HasUserPermissionOverwrites(
        ...
        .Any(x => x.Type == PermissionOverwriteType.Member
                  && x.ID.Value == discordUserId
                  && (discordPermissionType == DiscordPermissionType.All &&
                      (x.Allow.Value != BigInteger.Zero || x.Deny.Value != BigInteger.Zero)
...
public class DiscordPermissionHelper
{
    ...
    public bool HasBotEffectivePermissionsInChannel(ulong discordGuildId, IChannel discordChannelId,
    ...
    public bool HasBotEffectivePermissionsInChannel(ulong discordGuildId, ulong discordChannelId,
        params DiscordPermission[] permissions)
    {
        var guildChannel = _discordCache.GetGuildChannels(discordChannelId)
            .SingleOrDefault(x => x.ID.Value == discordChannelId);
    ...
    public bool HasUserEffectivePermissionsInChannel(ulong discordGuildId, IGuildMember guildMember,
        IChannel discordChannel, params DiscordPermission[] permissions)
    {
    ...
    public async Task<bool> HasUserEffectivePermissionsInChannel(ulong discordGuildId, ulong discordUserId,
        ulong discordChannelId, params DiscordPermission[] permissions)
    {
        var effectivePermissions =
            await GetUserEffectivePermissionsInChannel(discordGuildId, discordUserId, discordChannelId);
    ...
    public IDiscordPermissionSet? GetUserEffectivePermissionsInChannel(ulong discordGuildId, IGuildMember guildMember,
        IChannel discordChannel)
    {
        ...
        return DiscordPermissionSet.ComputePermissions(guildMember.User.Value!.ID, guildEveryoneRole, memberRoles,
            channelPermissionOverwrites);
    }

    public async Task<IDiscordPermissionSet?> GetUserEffectivePermissionsInChannel(ulong discordGuildId,
        ulong discordUserId, ulong discordChannelId)
    {
