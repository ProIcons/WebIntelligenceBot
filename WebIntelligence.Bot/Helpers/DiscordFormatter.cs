...
public static class DiscordFormatter
{
    ...
    public static string TimeToMarkdown(DateTimeOffset dateTimeOffset,
        TimeToMentionType type = TimeToMentionType.ShortDateTime) =>
        $"<t:{dateTimeOffset.ToUnixTimeSeconds()}:{(char)type}>";

    public static string TimeToMarkdown(DateTime dateTime, TimeToMentionType type = TimeToMentionType.ShortDateTime) =>
        TimeToMarkdown(dateTimeOffset: dateTime, type);
    ...
    public static string ToTimeMarkdown(this DateTime dateTime,
        TimeToMentionType type = TimeToMentionType.ShortDateTime) => TimeToMarkdown(dateTime, type);

    public static string ToTimeMarkdown(this DateTimeOffset dateTimeOffset,
        TimeToMentionType type = TimeToMentionType.ShortDateTime) => TimeToMarkdown(dateTimeOffset, type);
