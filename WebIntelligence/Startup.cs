...
namespace WebIntelligence
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "WebIntelligence", Version = "v1" });
            });
            ...
            services.AddWebIntelligenceDomain(Configuration);
            services.AddWebIntelligenceBot(Configuration);
            services.AddWebIntelligenceServices(Configuration);
        }
